...
<body>
  ...
  <script type="text/javascript" src="<?=HTTP_ROOT?>js/atom-full-compiled.js"></script>
  <? /*<script type="text/javascript" src="<?=HTTP_ROOT?>js/ImagePreloader.js"></script> */ ?>
  <script type="text/javascript" src="<?=HTTP_ROOT?>js/libcanvas-full-compiled.js"></script>
 ...
 <? /* <script type="text/javascript" src="<?=HTTP_ROOT?>js/movieclip-0.5.0.min.js"></script> */ ?>
  ...
  <script type="text/javascript" src="<?=HTTP_ROOT?>js/canvasActions_lib.js"></script>
